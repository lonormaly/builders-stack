...
- `ops/` — **private, non-shipped**: strategy, brand assets, and brand-recipe skills. **Not code, not a workspace, excluded from Nx**; in an open-core split it lives in your *private* repo, never the public one. Not a taxonomy peer — a non-code sibling like `docs/`. See `ops/README.md`.
